    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/perunoob">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://www.github.com/harshpreets63/Mirror-Bot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/perunoob"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See mirror-leech-telegram-bot <a href='https://www.github.com/harshpreets63/Mirror-Bot'>@GitHub</a> By <a href='https://github.com/Harshpreets63'>Harsh</a></h1>", content_type="text/html")
